...
exports.onPreExtractQueriesInvokeLeftoverPreviewCallbacks = exports.invokeAndCleanupLeftoverPreviewCallbacks = void 0;
var _ = require(".");
...
const invokeAndCleanupLeftoverPreviewCallbacks = async ({
  ...
  if (leftoverCallbacksExist) {
    ...
    (0, _store.getStore)().dispatch.previewStore.clearPreviewCallbacks();
  }
};
