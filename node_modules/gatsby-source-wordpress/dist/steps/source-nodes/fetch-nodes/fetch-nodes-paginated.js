      ...
      !(`since` in variables)) {
        ...
        if (existingNode) {
          ...
          if ((_node = node) !== null && _node !== void 0 && _node.databaseId && (_node2 = node) !== null && _node2 !== void 0 && _node2.uri && existingNode !== null && existingNode !== void 0 && existingNode.uri) {
            helpers.reporter.info((0, _formatLogMessage.formatLogMessage)(`Node with ID ${node.databaseId}/${node.id} of type ${node.__typename} was fetched multiple times. This is a WPGraphQL bug where pagination returns duplicate nodes.`));
          }
        }
      } else {
        idSet.add(node.id);
