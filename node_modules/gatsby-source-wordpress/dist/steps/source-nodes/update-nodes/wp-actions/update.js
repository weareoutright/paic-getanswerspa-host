...
const fetchAndCreateSingleNode = async ({
  ...
  let remoteNode = data[singleName] || data[(0, _camelCase2.default)(singleName)];
  if (!data || !remoteNode) {
...
const createSingleNode = async ({
  ...
  if (!cachedNodeIds && _gatsbyFeatures.needToTouchNodes) {
  ...
  let remoteNode = (0, _fetchReferencedMediaItems.addImageCDNFieldsToNode)({
    ...processedNode,
  ...
  if (remoteNode && _gatsbyFeatures.needToTouchNodes) {
    var _additionalNodeIds;
    cachedNodeIds.push(remoteNode.id);
    (_additionalNodeIds = additionalNodeIds) === null || _additionalNodeIds === void 0 ? void 0 : _additionalNodeIds.forEach(id => cachedNodeIds.push(id));
...
const normalizeUri = ({
  ...
  uri = (_uri = uri) === null || _uri === void 0 ? void 0 : _uri.replace(`preview=true`, ``);
