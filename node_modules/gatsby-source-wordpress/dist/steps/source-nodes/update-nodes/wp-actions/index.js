...
exports.handleWpActions = exports.getWpActions = exports.fetchAndRunWpActions = void 0;
...
const getWpActions = async ({
  ...
  await helpers.cache.set((0, _store.withPluginKey)(_constants.LAST_COMPLETED_SOURCE_TIME), sourceTime);
