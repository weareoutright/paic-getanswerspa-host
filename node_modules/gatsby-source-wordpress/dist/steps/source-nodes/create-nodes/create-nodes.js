...
exports.createNodeWithSideEffects = exports.createGatsbyNodesFromWPGQLContentNodes = void 0;
...
const createNodeWithSideEffects = ({
  ...
  const builtTypename = (0, _helpers.buildTypeName)(node.__typename, pluginOptions.schema.typePrefix);
  let remoteNode = {
    ...node,
...
const createGatsbyNodesFromWPGQLContentNodes = async ({
   ...
   */
  if (!pluginOptions.type.MediaItem.exclude && (!pluginOptions.type.MediaItem.lazyNodes || _gatsbyVersion.usingGatsbyV4OrGreater) && referencedMediaItemNodeIdsArray.length) {
