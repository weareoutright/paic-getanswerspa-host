...
const buildDefaultResolver = transformerApi => (source, _, context) => {
  ...
  if ((_finalFieldValue = finalFieldValue) !== null && _finalFieldValue !== void 0 && _finalFieldValue.__typename) {
    ...
    finalFieldValue.__typename = (0, _helpers.buildTypeName)(finalFieldValue.__typename, prefix);
  }
  const isANodeConnection =
  // if this field has just an id and typename
  ((_finalFieldValue2 = finalFieldValue) === null || _finalFieldValue2 === void 0 ? void 0 : _finalFieldValue2.id) && ((_finalFieldValue3 = finalFieldValue) === null || _finalFieldValue3 === void 0 ? void 0 : _finalFieldValue3.__typename) && Object.keys(finalFieldValue).length === 2 &&
