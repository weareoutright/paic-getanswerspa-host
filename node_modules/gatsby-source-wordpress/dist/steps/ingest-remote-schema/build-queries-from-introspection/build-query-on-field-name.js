...
exports.generateReusableFragments = exports.buildSelectionSet = exports.buildNodesQueryOnFieldName = exports.buildNodeQueryOnFieldName = void 0;
...
const buildInlineFragments = (inlineFragments, {
  fragments = {}
      ...
      __typename
      ${inlineFragments.map(inlineFragment => buildInlineFragment({
  ...inlineFragment,
  fragments
})).join(` `)}
    ` : ``;
const buildSelectionSet = (fields, {
  ...
  const buildFieldSelectionSet = field => {
    ...
    if (fieldName && (builtInlineFragments !== `` || selectionSet !== ``)) {
      ...
      const fullFieldType = typeMap.get((0, _helpers.findNamedTypeName)(fieldType));
