...
exports.remoteSchemaSupportsFieldNameOnTypeName = exports.introspectAndStoreRemoteSchema = void 0;
...
const introspectAndStoreRemoteSchema = async () => {
  ...
  if (staleIntrospectionData && printSchemaDiff) {
    ...
    staleIntrospectionData.__schema.types.forEach(type => {
      ...
      const typeDiff = type && newType ? (0, _uniqBy2.default)(diff.diffJson(type, newType), `value`) : null;
